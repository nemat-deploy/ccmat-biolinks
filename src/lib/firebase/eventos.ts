...
import type { Evento, EventoSemId, Participante } from "@/types";
  ...
  try {
    ...
    return snapshot.docs.map(doc => {
      ...
      return {
        ...
        dataInscricao: data.dataInscricao ? data.dataInscricao.toDate() : null,
...
export function buildEventoSemId(params: Partial<Evento>): EventoSemId {
  return {
    name: params.name ?? "",
